            ...
            <div class="account__content account__content--active">
                ...
                @else
                    <div class="empty-state">
                        ...
                        <h2 class="empty-state__title">You haven't placed any orders yet.</h2>
                        <p class="empty-state__description">Start shopping and your orders will appear here.</p>
                        <x-link href="/shop" color="primary" size="md">Continue shopping</x-link>
                    </div>
                @endif
            </div>
        </div>
